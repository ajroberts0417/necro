...
import necro.BasicMod;
import necro.util.CardStats;
import static necro.util.GeneralUtils.removePrefix;
import static necro.util.TextureLoader.getCardTextureString;
import necro.util.TriFunction;
