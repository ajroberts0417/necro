...
import static necro.BasicMod.characterPath;
import static necro.BasicMod.makeID;

public class Necro extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Necro"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass NECRO;
        @SpireEnum(name = "NECRO_WHITE_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "NECRO_WHITE_COLOR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Necro(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
